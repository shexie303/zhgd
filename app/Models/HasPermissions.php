...
trait HasPermissions
{
    ...
    {
        $pivotTable = config('admin.database.site_role_users_table');

        $relatedModel = config('admin.database.site_roles_model');
    ...
    {
        $pivotTable = config('admin.database.site_user_permissions_table');

        $relatedModel = config('admin.database.site_permissions_model');
