 ...
 */
//查询操作
//  $db->table('user')->where('id > 2')->order('id desc')->limit('2,4')->select();
//插入操作
//  $db->table('site_error_report')->insert($data);
//更新操作
//  $db->table('user')->where('id = 1')->update(array('username'=>'user1','password'=>'pwd1'));
//删除操作
